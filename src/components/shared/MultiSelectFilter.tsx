    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          >
            {searchable && (
              <input autoFocus value={q} onChange={(e) => setQ(e.target.value)} placeholder={t("filter.search")} className="text-xs w-full px-2 py-1.5 border-b" style={{ borderColor: "#F1F5F9", outline: "none" }} />
            )}
            {selected.size > 0 && (
