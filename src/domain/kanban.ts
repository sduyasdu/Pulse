 ...
 * date (Feature.x ascending, title as tiebreak). Only epics with at least one
 * task in that column get a band (in `epics` array order); a "No epic" group
 * (features with no/unknown epicId) is appended last when it has tasks. Pure and
