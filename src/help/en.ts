  ...
  sections: [
    ...
    },
    {
      ...
      bullets: [
        ...
        { term: "Linking isn't access", text: "It says who someone is, not what they can open. They still need inviting to each Pulse — and the invite form offers the ones who haven't been." },
