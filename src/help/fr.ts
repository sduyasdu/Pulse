...
export const help: HelpDoc = {
  ...
  sections: [
    ...
    },
    {
      ...
      body:
        "Invitez une personne précise, ou partagez un lien utilisable par n'importe qui. Chacun voit les changements au fil de l'eau.",
      keywords: ["inviter", "partager", "permission", "role", "lecteur", "editeur", "proprietaire", "commentaire", "mention", "historique", "qui a modifie", "masquer", "archiver", "lecture seule", "termine", "e-mail", "confirmer", "verifier", "invitation", "rejoindre"],
      bullets: [
        { term: "Inviter une personne", text: "Seul le propriétaire de cette adresse peut accepter, le lien est donc sans risque à coller n'importe où. Les personnes déjà liées à une ressource d'ici sont proposées dans la liste." },
