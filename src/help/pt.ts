...
export const help: HelpDoc = {
  ...
  sections: [
    ...
    },
    {
      ...
      body:
        "Convide uma pessoa específica ou compartilhe um link que qualquer um pode usar. Todos veem as mudanças conforme elas acontecem.",
      keywords: ["convidar", "compartilhar", "permissao", "papel", "leitor", "editor", "proprietario", "comentario", "mencao", "historico", "quem mudou", "ocultar", "arquivar", "somente leitura", "concluido", "e-mail", "confirmar", "verificar", "convite", "entrar"],
      bullets: [
        { term: "Convidar uma pessoa", text: "Só quem é dono desse endereço pode aceitar, então o link é seguro para colar em qualquer lugar. Quem já está vinculado a um recurso daqui aparece na lista." },
